...
import { VideoCameraFilled, RightOutlined, LeftOutlined, LinkOutlined, SelectOutlined, DownloadOutlined, CloudDownloadOutlined } from '@ant-design/icons';
...
const VideoLecture = ({ match, dispatch, ...props }) => {
